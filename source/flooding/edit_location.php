    ...
    <body>
        ...
        <?php
            ...
            if($_SERVER["REQUEST_METHOD"] == "POST"){
                // Update the record
                $locationId = sanitize($_POST["locationIdInput"]);
                ...
                // prepare and bind
                $stmt = $conn->prepare("UPDATE location SET name=?, waterLevelL=?, waterLevelU=?, flowRateL=?, flowRateU=?, temperatureL=?, temperatureU=?, humidityL=?, humidityU=? WHERE id=?");
                $stmt->bind_param("ssssssssss", $locationName, $waterLevelL, $waterLevelU,
                    $flowRateL, $flowRateU, $temperatureL, $temperatureU, $humidityL,$humidityU,$locationId);
                $stmt->execute();
        ...
        <div class="container" class="mb-5" style="max-width: 650px; margin-top: 32px;">
            <form class="card p-5" method="post" action="<?php echo htmlSpecialChars($_SERVER['PHP_SELF']); ?>">
                ...
                <input type="text" style="display:none" id="locationIdInput" name="locationIdInput" value="<?php if($_SERVER["REQUEST_METHOD"] != "POST"){echo $_GET["locationId"];}?>">
                <div class="row mb-3"> 
                    <label for="locationName" class="col-sm-3 col-form-label">location Name</label>
                    <div class="col-sm-9">
                        <input type="text" class="form-control" name="locationName" id="locationName" value="<?php echo $row["name"] ?>">
                    </div>
                </div>
                <div class="row mb-3"> 
                    ...
                    <div class="col-sm-3">
                        <input type="text" class="form-control" name="waterLevelL" id="waterLevelL" value="<?php echo $row["waterLevelL"] ?>">
                    </div>
                    <label for="waterLevelU" class="col-sm-3 col-form-label">Critical Threshold</label>
                    <div class="col-sm-3">
                        <input type="text" class="form-control" name="waterLevelU" id="waterLevelU" value="<?php echo $row["waterLevelU"] ?>">
                    </div>
                </div>
                <div class="row mb-3"> 
                    ...
                    <div class="col-sm-3">
                        <input type="text" class="form-control" name="flowRateL" id="flowRateL" value="<?php echo $row["flowRateL"] ?>">
                    </div>
                    <label for="flowRateU" class="col-sm-3 col-form-label">Critical Threshold</label>
                    <div class="col-sm-3">
                        <input type="text" class="form-control" name="flowRateU" id="flowRateU" value="<?php echo $row["flowRateU"] ?>">
                    </div>
                </div>
                <div class="row mb-3"> 
                    ...
                    <div class="col-sm-3">
                        <input type="text" class="form-control" name="temperatureL" id="temperatureL" value="<?php echo $row["temperatureL"] ?>">
                    </div>
                    <label for="temperatureU" class="col-sm-3 col-form-label">Upper Limit</label>
                    <div class="col-sm-3">
                        <input type="text" class="form-control" name="temperatureU" id="temperatureU" value="<?php echo $row["temperatureU"] ?>">
                    </div>
                </div>
                <div class="row mb-3"> 
                    ...
                    <div class="col-sm-3">
                        <input type="text" class="form-control" name="humidityL" id="humidityL" value="<?php echo $row["humidityL"] ?>">
                    </div>
                    <label for="humidityU" class="col-sm-3 col-form-label">Upper Limit</label>
                    <div class="col-sm-3">
                        <input type="text" class="form-control" name="humidityU" id="humidityU" value="<?php echo $row["humidityU"] ?>">
                    </div>
                </div>
                ...
                <div class="row mb-3" style="margin-top: 40px;"> 
                    ...
                    <div class="col-sm-6  position-relative">
                        ...
                        <a href="delete_location.php?locationId=<?php if($_SERVER["REQUEST_METHOD"] != "POST"){echo $_GET["locationId"];} ?>" class="position-absolute top-0 start-100 translate-middle btn btn-sm btn-danger" style="height:2rem">Delete</a>
                    </div>
                    <div class="col-sm-3"></div>
